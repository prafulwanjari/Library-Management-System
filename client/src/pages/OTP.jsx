      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative" >
        ...
        <div className="max-w-sm w-full">
          ...
          <form onSubmit={handleOtpVerification}>
            <div className="mb-4">
              <input type="number" value={otp} onChange={(e) => setOptp(e.target.value)} placeholder="OTP" className="w-full px-4 py-3 border border-black rounded-md focus:outline-none" />
            </div>
            <button type="submit" className="border-2 mt-5 w-full font-semibold text-white py-2  border-black rounded-lg hover:bg-white hover:text-black transition bg-black uppercase">Verify</button>
          </form>
        </div>
